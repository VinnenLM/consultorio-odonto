...
public class FormFuncionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/funcionario2.png"))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jP_senha, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jButton3, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jT_nome, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jF_cpf, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jT_telefone, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jT_email, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jC_sexo, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jT_id, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(183, 419, Short.MAX_VALUE))))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(60, 60, 60)
        ...
        jT_funcionario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "CPF", "Telefone", "Email", "Sexo"
            }
        ) {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        int opcao = jT_funcionario.getSelectedRow();
        if (opcao >= 0) {
            jB_cadastrar.setText("Atualizar");
            jT_id.setText(jT_funcionario.getValueAt(opcao, 0).toString());
            jT_nome.setText(jT_funcionario.getValueAt(opcao, 1).toString());
            jF_cpf.setText(jT_funcionario.getValueAt(opcao, 2).toString());
            jT_telefone.setText(jT_funcionario.getValueAt(opcao, 3).toString());
            jT_email.setText(jT_funcionario.getValueAt(opcao, 4).toString());
            jC_sexo.setSelectedItem(jT_funcionario.getValueAt(opcao, 5).toString());
            jTabbedPane1.setSelectedIndex(0);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if (opcao >= 0) {
            ...
            f.setId_funcionario(Integer.parseInt(jT_funcionario.getValueAt(opcao, 0).toString()));
    ...
    public void preencherTabela() {
        MetFuncionario metf = new MetFuncionario();
        List<Funcionario> lista = metf.ListarTodos();
        DefaultTableModel modeloTabela = (DefaultTableModel) jT_funcionario.getModel();
        modeloTabela.setRowCount(0);
        for (Funcionario f : lista) {
            modeloTabela.addRow(new Object[]{f.getId_funcionario(), f.getNome(), f.getCpf(), f.getTelefone(), f.getEmail(), f.getSexo()});
        }
    }

    public void preencherTabela(String nome) {
        MetFuncionario metpac = new MetFuncionario();
        List<Funcionario> lista = metpac.ListarNome(nome);
        DefaultTableModel modeloTabela = (DefaultTableModel) jT_funcionario.getModel();
        modeloTabela.setRowCount(0);
        for (Funcionario f : lista) {
            modeloTabela.addRow(new Object[]{f.getId_funcionario(), f.getNome(), f.getCpf(), f.getTelefone(), f.getEmail(), f.getSexo()});
    ...
    public void cadastrar(){
        ...
        user.setSenha(jP_senha.getText());
        user.setPerfil("Funcionario");

        Funcionario f = new Funcionario();
        f.setNome(jT_nome.getText());
        f.setCpf(jF_cpf.getText());
        f.setSexo(jC_sexo.getSelectedItem().toString());
        f.setTelefone(jT_telefone.getText());
        f.setEmail(jT_email.getText());
        MetFuncionario metf = new MetFuncionario();
        MetUsuario metuser = new MetUsuario();

        if (jT_nome.getText().isEmpty() || jF_cpf.getText().isEmpty() || jT_telefone.getText().isEmpty()) {
